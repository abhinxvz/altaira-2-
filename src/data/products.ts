export const products = [
  {
    id: 1,
    name: "FEIN OVERSIZED TEE",
    price: 799,
    image: "https://onefortee.com/cdn/shop/files/DSC2872.jpg?v=1725007340&width=493",
    description: "Experience the energy of the current hip hop culture with our FEIN OVERSIZED TEE! Boldly designed and crafted with passion, this tee showcases the vibrant and captivating essence of the modern hip hop world⚡️"
  },
  {
    id: 2,
    name: "DRIP OVERSIZED TEE",
    price: 899,
    image: "https://onefortee.com/cdn/shop/files/DSC3255.jpg?v=1725007017&width=493",
    description: "Our DRIP OVERSIZED TEE features a unique design that represents the significance of each drip in creating a masterpiece. Stay comfortable while making a statement with this eye-catching top. Made to perfection for those who appreciate artistic detail🎭"
  },
  {
    id: 3,
